      ...
      <div className="bg-slate-900 rounded-2xl p-3 text-white font-semibold ">
        ...
        <div className="flex flex-col gap-3 px-2">
          ...
          <div className="flex justify-center items-center w-full ">
            <button
              onClick={() => googleAuth()}
              className="w-1/2 bg-slate-800 rounded-lg p-2 hover:bg-slate-700 flex justify-center items-center w-full"
            >
              <img src={googleLogo} alt="google-logo" className="size-8 brightness-1000 grayscale"/>
            </button>
          </div>
        </div>
